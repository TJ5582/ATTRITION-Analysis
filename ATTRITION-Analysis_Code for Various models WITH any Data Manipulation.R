################# Code file with all data manipulation
...
#### Outliar finding by creating Box plots
...
#### Outliar Imputation using Winsorizing technique
...
################## MODEL BUILDING AFTER DATA MANIPULATION
...
# code to find imporatnat variables from Logistic Regression model
...
################## Logistic Regression Model with all important variables provided by varImp() function
...
################## Logistic Regression Model with all important variables provided by varImp() function using Chisq Test
...
##################### DECISION TREE  = Information Gain method with all variables ######################
...
# code to find important variables from Decision Tree = Information Gain model
...
##################### DECISION TREE  = Information Gain method with all IMPORTANT variables ######################
...
##################### DECISION TREE  = Gini Index method with all variables ######################
...
# code to find important variables from Decision Tree = Gini Index model
...
##################### DECISION TREE  = Gini Index method with all IMPORTANT variables ######################
...
# code to find important variables from Random Forest model
varImp(rfit)
...
##################### RANDOM FOREST Model with all IMPORTANT variables INFO GAIN method ######################
...
##################### RANDOM FOREST Model with all IMPORTANT variables Gini Index method ######################
set.seed(500)
...
# code to find important variables from SVM model
...
##################### SVM Model with all IMORTANT variables ######################
